...
type SupportOptions struct {
	// 导出类型文件
	ExportDefine (func(sheet *parser.XlsxSheet, outpath string) (err error))
	// 合并导出类型
	ExportMergeDefine (func(sheets []*parser.XlsxSheet, outpath string) (err error))
	// 导出数据文件
	ExportData (func(sheet *parser.XlsxSheet, outpath string) (err error))
	// 合并导出数据
	ExportMergeData (func(sheets []*parser.XlsxSheet, outpath string) (err error))
	// 检测配置
	CheckOptions func() error
}

// 导出类型文件
func WithExportDefine(v func(sheet *parser.XlsxSheet, outpath string) (err error)) SupportOption {
...
// 合并导出类型
func WithExportMergeDefine(v func(sheets []*parser.XlsxSheet, outpath string) (err error)) SupportOption {
	return func(cc *SupportOptions) SupportOption {
...
// 导出数据文件
func WithExportData(v func(sheet *parser.XlsxSheet, outpath string) (err error)) SupportOption {
	return func(cc *SupportOptions) SupportOption {
...
// 合并导出数据
func WithExportMergeData(v func(sheets []*parser.XlsxSheet, outpath string) (err error)) SupportOption {
	return func(cc *SupportOptions) SupportOption {
